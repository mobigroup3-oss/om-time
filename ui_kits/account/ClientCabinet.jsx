...
// Личный кабинет клиента: приветствие, прикреплённый специалист, график веса
// (window.WeightChart → внутри DiaryTable + MeasureReport) и лента комментариев
// со специалистом. Данные — /api/clients?action=me, лента —
